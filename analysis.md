...
&ensp; &ensp; Main Kill: Kills achieved by the player with the help of teammates. But the player did more than 65% of the &ensp; &ensp; damage to the enemy. <br />
&ensp; &ensp; Regular Kill: Kills achieved by the player with the help of teammates. But the player did between 10%-65% &ensp; &ensp; damage to the enemy.<br />
